...
const RestaurantBusinessDemo = ({ userData }: { userData?: any }) => {
  ...
  const financialData = [
    { month: "Ocak", revenue: 42500, expenses: 28000 },
    { month: "Şubat", revenue: 38700, expenses: 27500 },
    { month: "Mart", revenue: 47800, expenses: 29200 },
    { month: "Nisan", revenue: 51300, expenses: 30100 },
    { month: "Mayıs", revenue: 59000, expenses: 32400 },
    { month: "Haziran", revenue: 69500, expenses: 36800 },
  ];
      ...
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          <h2 className="text-2xl font-bold flex items-center">
            ...
            Restoran İşletme Paneli (Demo)
          </h2>
          <p className="text-muted-foreground">
            Bu panel restoran işletme sahiplerine özel olan panelin demo versiyonudur.
          </p>
        </div>
      </div>
        ...
        <TabsContent value="analytics" className="mt-0">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Restoranınızın finansal performansını takip edin.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="text-2xl font-bold">€36,800</div>
                          ...
                          {financialData.map((month, index) => (
                            <div key={index} className="flex-1 flex flex-col justify-end items-center gap-1 px-1">
                              ...
                              <div 
                                ...
                                style={{ height: `${(month.expenses / 70000) * 100}%` }}
                              ></div>
...
export default RestaurantBusinessDemo;
